...
public:
    ...
    static void InitQuaternion(float *init_q4)
    {
        ...
        {
            acc_init[X] += BMI088::cBMI088::Instance()->bmi088_data.acc_data.x;
            acc_init[Y] += BMI088::cBMI088::Instance()->bmi088_data.acc_data.y;
            acc_init[Z] += BMI088::cBMI088::Instance()->bmi088_data.acc_data.z;
            DWT_Delay(0.001);
        }
        for (uint8_t i = 0; i < 3; ++i)
            acc_init[i] /= 100;
