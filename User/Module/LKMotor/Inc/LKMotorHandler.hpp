...
public:
     ...
     * @param canId 电机ID
     */
    void registerMotor(LKMotor *LKmotor, FDCAN_HandleTypeDef *hcan, uint16_t canId); // 使用指针作为参数
    ...
    void processZeroPointData(FDCAN_HandleTypeDef *hcan, uint8_t *rx_data, int index);
