...
/*---------------------------相关宏定义---------------------------*/
#define BMI088_SPI hspi2 //< SPI句柄

#define BMI088_ACC_GPIOx GPIOC      //< 加速度计片选端口
#define BMI088_ACC_GPIOp GPIO_PIN_0 //< 加速度计片选引脚

#define BMI088_GYRO_GPIOx GPIOC      //< 陀螺仪片选端口
#define BMI088_GYRO_GPIOp GPIO_PIN_3 //< 陀螺仪片选引脚

#define HEATING_RESISTANCE_TIM htim3            //< 加热电阻定时器
#define HEATING_RESISTANCE_CHANNEL TIM_CHANNEL_4 //< 加热电阻通道
