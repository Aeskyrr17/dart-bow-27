...
public:
    ...
    DartLibrary()
    {
        dart[1] = {1, 0.0f,10000.0f};
        dart[2] = {2, 0.0f,10000.0f};
        dart[3] = {3, 0.0f,10000.0f};
        dart[4] = {4, 0.0f,10000.0f};
        dart[5] = {5, 0.0f,10000.0f};
        dart[6] = {6, 0.0f,10000.0f};
        dart[7] = {7, 0.0f,10000.0f};
        dart[8] = {8, 0.0f,10000.0f};
        dart[9] = {9, 0.0f,10000.0f};
