...
[[noreturn]] void PendulumThreadFun(ULONG initial_input)
{
    ...
    /* Legs Initialization */
    PID lleg_len_pd(4700.0f, 0.0f, 700.0f, 3000.0f, 0.0f, PID_DVEL);
    PID rleg_len_pd(4700.0f, 0.0f, 700.0f, 3000.0f, 0.0f, PID_DVEL);
    ...
    for (;;)
    {
        ...
        observedX[0] = 0.5f*(solver_fdb.lphi + solver_fdb.rphi - Pi) + ins.pitch;
        observedX[1] = 0.5f*(solver_fdb.lphi_dot + solver_fdb.rphi_dot) + ins.gyro_p;
        observedX[2] = odom.x;
        observedX[3] = odom.v;
        observedX[4] = ins.pitch;
        observedX[5] = ins.gyro_p;

        // refX[0] = 0.0f;
        // refX[1] = 0.0f;
        // refX[2] = observedX[2] + vy*0.002f;
        // refX[3] = vy;
        // refX[4] = 0.0f;
        // refX[5] = 0.0f;
        ...
        pendulum_ctrl.Tl[1] = Tout[0]*0.5f;
        pendulum_ctrl.Tr[1] = Tout[0]*0.5f;
        pendulum_ctrl.Twl = Tout[1];
